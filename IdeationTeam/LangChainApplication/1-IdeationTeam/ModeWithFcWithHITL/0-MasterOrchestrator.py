"""
Master Orchestrator for Research Question Generation with Firecrawl and Human-in-the-Loop
This script runs all three stages sequentially with Firecrawl web scraping and human feedback between rounds.

Pipeline:
1. Sourcing Stage: Gather literature from APIs + Firecrawl (2 rounds with feedback)
...
def main():
    """Main orchestrator that runs all three stages with Firecrawl and human-in-the-loop."""
    ...
    print("\n" + "="*70)
    print("RESEARCH QUESTION GENERATION PIPELINE WITH FIRECRAWL & HITL")
    print("Mode: With FireCrawl, With Human Feedback")
    print("="*70)
    ...
    print("\n" + "="*70)
    print("STAGE 1: LITERATURE SOURCING WITH FIRECRAWL & HUMAN FEEDBACK")
    print("="*70)
